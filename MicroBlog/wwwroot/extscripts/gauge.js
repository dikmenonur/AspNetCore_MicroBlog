...
(function () {
    ...
    TextRenderer = (function () {
        ...
        TextRenderer.prototype.render = function (gauge) {
            var outputValue = formatNumber(gauge.displayedValue, this.fractionDigits);
            if (null != gauge.options.labelFormatter) {
                outputValue = gauge.options.labelFormatter(outputValue);
            }
            return this.el.innerHTML = outputValue;
        };
